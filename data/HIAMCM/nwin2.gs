...
'set string 1 c 3  0  '
'set strsiz 0.13'
"draw string 5.3  7.13 (a) 156`a `nkm`a `n<`a `n`3l`0`bH `n<`a `n1350`a `nkm: average horizontal wind variation (ms`a-1`n), 50`ao`nN-90`ao`nN"
"draw string 5.3  3.63 (b) 156`a `nkm`a `n<`a `n`3l`0`bH `n<`a `n1350`a `nkm: average temperature variation (K), 50`ao`nN-90`ao`nN"
