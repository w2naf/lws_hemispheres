...
* GW y-momentum deposition
'set vpage  0.5 10.5  3.6   7.4 '
'set parea  1.0 9.5   0.7   3.7'
'set gxout shaded'
'set ccols 9  14   19   4   11   5    3  0  7  12  8     '
'set clevs  -200 -120 -80 -40  -20  -10 -5  5  10  20  '
'set grads off'
'd ave(dragy,lat=50,lat=70)  '
*xl = 9.6; xwid = 0.2 ; yb = 0.710 ; ywid = 0.229
xl = 9.6; xwid = 0.2 ; yb = 0.710 ; ywid = 0.272    
dummy = vcbar (xl,xwid,yb,ywid)

* average GW vert. wind perturbation as in nwin3
...
*xl = 9.6; xwid = 0.2 ; yb = 0.610 ; ywid = 0.248 ;
...
'set string 1 c 3  0  '
'set strsiz 0.13'
"draw string 5.3  7.13 (a) 156`a `nkm`a `n<`a `n`3l`0`bH `n<`a `n1350`a `nkm: y-momentum deposition (ms`a-1`n), 50`ao`nN-70`ao`nN"
