...
#        radars  = ['ade', 'adw', 'bks', 'cve', 'cvw', 'cly', 'fhe', 'fhw', 'gbr', 'han', 'hok', 'hkw', 'inv', 'jme', 'kap', 'ksr', 'kod', 'lyr', 'pyk', 'pgr', 'rkn', 'sas', 'sch', 'sto', 'wal']
    ...
    for radar in radars:
        ...
        try:
            pydarn.RTP.plot_range_time(fitacf, beam_num=beam, parameter='p_l', zmin=zmin, zmax=zmax, cmap='jet',
...
if __name__ == '__main__':
    ...
    date_1      = datetime.datetime(2017,11,3)
    ...
    for rd in run_dicts:
        plot_hemisphere_dict(rd)
#    import ipdb; ipdb.set_trace()
#    plot_hemisphere(sTime,hemisphere=hemisphere,output_dir=output_dir)
